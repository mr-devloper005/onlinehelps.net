export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'onlinehelps',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Onlinehelps',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'onlinehelps.net',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://onlinehelps.net',
